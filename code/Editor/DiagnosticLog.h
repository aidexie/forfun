...
public:
    static CDiagnosticLog& Instance() {
        static CDiagnosticLog instance;
        return instance;
    }
...
private:
    CDiagnosticLog() = default;
    ~CDiagnosticLog() = default;
    CDiagnosticLog(const CDiagnosticLog&) = delete;
    CDiagnosticLog& operator=(const CDiagnosticLog&) = delete;
