// DebugLine_DS.gs.hlsl
// Geometry Shader to expand lines into thick quads (SM 5.1 - Descriptor Set path)

// PerPass constant buffer (space1) - slot b1 to avoid conflict with VS b0
cbuffer CBPerFrameGS : register(b1, space1) {
