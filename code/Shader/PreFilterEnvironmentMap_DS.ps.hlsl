// ============================================
// PreFilterEnvironmentMap_DS.ps.hlsl - Prefilter PS (SM 5.1)
// ============================================
...
// Constant Buffer (b0, space1) - Combined face index and roughness
cbuffer CB_Prefilter : register(b0, space1) {
