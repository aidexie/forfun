...
// ============================================
// Histogram-based automatic exposure with eye adaptation.
//
// Entry Points:
...
// Histogram generation constants (b0)
cbuffer CB_Histogram : register(b0) {
    float2 gScreenSize;
...
// Adaptation pass
StructuredBuffer<uint> gHistogramSRV : register(t0);
RWStructuredBuffer<float> gExposure : register(u0);  // [0] = current, [1] = target, [2] = maxHistogramValue
