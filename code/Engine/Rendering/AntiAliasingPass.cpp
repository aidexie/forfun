...
void CAntiAliasingPass::renderSMAA(ICommandList* cmdList,
                                   ...
                                   uint32_t width, uint32_t height,
                                   const SAntiAliasingSettings& settings) {
    // SMAA not yet migrated to descriptor sets - disabled for now
    // TODO: Migrate SMAA to descriptor sets
    CFFLog::Warning("[AntiAliasing] SMAA not available - not yet migrated to descriptor sets");
}
